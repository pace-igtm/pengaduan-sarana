                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                $color = $status == 'Selesai' ? 'success' : ($satus == 'Proses' ? 'warning' : 'secondary');
                            @endphp
                            <span class="badge bg-{{ $color }}">{{ $status }}</span>
                        </td>
                        <td>
                            <button type="button" class="btn btn-sm btn-info text-white" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $row->id_pelaporan }}">
                                Update
                            </button>
                        </td>
                    </tr>
                    ...
                    <div class="modal-fade" id="modalEdit{{ $row->id_pelaporan }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.update', $row->id_pelaporan)}}"method="POST">
                                    @csrf
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="feedback" class="form-control" rows="3" placeholder="Contoh: Sudah diperbaiki oleh teknisi ">{{ $row->aspirasi->feedback }}</textarea>
                                        </div>
                                    </div>
